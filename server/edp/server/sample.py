...
def find_samples(project, composite, runId=None, platemapId=None, elements=None, offset=0, limit=None, sort=None):
...
class Sample(resource.create(SampleModel)):
    ...
    def find(self, project, composite, runId, platemapId, elements, offset=0, limit=None, sort=None):
        return find_samples(project, composite, runId, platemapId, elements, offset, limit, sort)